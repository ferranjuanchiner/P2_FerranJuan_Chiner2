...
package com.example.android.P2_JuanChiner_Ferran2;
 ...
 * touched, an intent starts {@link FilmDetailActivity} representing
 * song details.
 */
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter
                (new SimpleItemRecyclerViewAdapter(FilmUtils.FILM_ITEMS));
    }
    ...
    class SimpleItemRecyclerViewAdapter
        ...
        private final List<FilmUtils.Film> mValues;

        SimpleItemRecyclerViewAdapter(List<FilmUtils.Film> items) {
            mValues = items;
        }
         ...
         * If mTwoPane is not true, it starts FilmDetailActivity
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.mContentView.setText(mValues.get(position).film_title);
            holder.mView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Context context = v.getContext();
                    Intent intent = new Intent(context,
                            FilmDetailActivity.class);
